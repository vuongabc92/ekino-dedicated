<?php
/**
 * File for Pr_sso_model_webserviceWsdlClass to communicate with SOAP service
 ...
 */
/**
 * Pr_sso_model_webserviceWsdlClass to communicate with SOAP service
 * 
 * @package Pr_sso_model_webservice
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20140325-01
 * @date 2015-01-30
 */
class Pr_sso_model_webserviceWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://ws.pernod-ricard.com/sfdc/authentication.asmx?WSDL';
    /**
    ...
    /**
     * Constructor
     * @uses Pr_sso_model_webserviceWsdlClass::setLastError()
     * @uses Pr_sso_model_webserviceWsdlClass::initSoapClient()
     * @uses Pr_sso_model_webserviceWsdlClass::initInternArrayToIterate()
     * @uses Pr_sso_model_webserviceWsdlClass::_set()
     ...
     * @return Pr_sso_model_webserviceWsdlClass
     */
     ...
     * @return Pr_sso_model_webserviceWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'Pr_sso_model_webserviceWsdlClass'))
            {
     ...
     * @uses Pr_sso_model_webserviceClassMap::classMap()
     * @uses Pr_sso_model_webserviceWsdlClass::getDefaultWsdlOptions()
     * @uses Pr_sso_model_webserviceWsdlClass::getSoapClientClassName()
     * @uses Pr_sso_model_webserviceWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('Pr_sso_model_webserviceClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = Pr_sso_model_webserviceClassMap::classMap();
     ...
     * If a class is named as {Pr_sso_model_webservice}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('Pr_sso_model_webserviceSoapClient') && is_subclass_of('Pr_sso_model_webserviceSoapClient','SoapClient'))
            return 'Pr_sso_model_webserviceSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_CACHE_WSDL
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_COMPRESSION
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_ENCODING
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_EXCEPTIONS
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_FEATURES
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_LOGIN
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_PASSWORD
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_SOAP_VERSION
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_STREAM_CONTEXT
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_TRACE
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_TYPEMAP
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_URL
     * @uses Pr_sso_model_webserviceWsdlClass::VALUE_WSDL_URL
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_USER_AGENT
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_PROXY_HOST
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_PROXY_PORT
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_PROXY_LOGIN
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_PROXY_PASSWORD
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_LOCAL_CERT
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_PASSPHRASE
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_AUTHENTICATION
     * @uses Pr_sso_model_webserviceWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::getSoapClient()
     * @uses Pr_sso_model_webserviceWsdlClass::getFormatedXml()
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::getSoapClient()
     * @uses Pr_sso_model_webserviceWsdlClass::convertStringHeadersToArray()
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::count()
     * @return int
     */
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::getInternArrayToIterate()
     * @uses Pr_sso_model_webserviceWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::getInternArrayToIterateOffset()
     * @uses Pr_sso_model_webserviceWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::getInternArrayToIterateOffset()
     * @uses Pr_sso_model_webserviceWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see Pr_sso_model_webserviceWsdlClass::offsetGet()
     * @uses Pr_sso_model_webserviceWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::getAttributeName()
     * @uses Pr_sso_model_webserviceWsdlClass::__toString()
     * @uses Pr_sso_model_webserviceWsdlClass::_set()
     * @uses Pr_sso_model_webserviceWsdlClass::_get()
     * @uses Pr_sso_model_webserviceWsdlClass::setInternArrayToIterate()
     * @uses Pr_sso_model_webserviceWsdlClass::setInternArrayToIterateIsArray()
     * @uses Pr_sso_model_webserviceWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses Pr_sso_model_webserviceWsdlClass::item()
     * @uses Pr_sso_model_webserviceWsdlClass::length()
     * @return mixed
     */
