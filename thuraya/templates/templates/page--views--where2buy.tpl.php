...
//echo "<pre>";print_r($views_page->result);
//echo "<pre>"; print_r($views_page->result[0]->_field_data[nid][entity]->field_partner_tier[und]); exit;
?>
<script>
window.onload = function() {
	...
	oms.addListener('spiderfy', function(markers) {
		for(var i = 0; i < markers.length; i ++) {
			...
			markers[i].setIcon('http://prenew.thuraya.com/sites/all/themes/thuraya/images/marker-dark.png');
	...
	oms.addListener('unspiderfy', function(markers) {
		for(var i = 0; i < markers.length; i ++) {
		  ...
		  markers[i].setIcon('http://prenew.thuraya.com/sites/all/themes/thuraya/images/marker.png');
	...
	if (window.mapData.length == 0) {
		...
		for (var i = 0; i < window.mapData.length; i ++) {
			...
			var marker = new gm.Marker({
			  ...
			  icon: 'http://prenew.thuraya.com/sites/all/themes/thuraya/images/marker.png',
			  shadow: shadow
			});
			marker.desc = datum.d;
			oms.addMarker(marker);
		}
		if (window.mapData.length < 80) {
