...
$field_main_sector=$node->field_main_sector['und']['0']['nid'];
$main_path = $base_url.'/'.drupal_get_path_alias('node/'.$field_main_sector);
$subSectors = get_subsectors($field_main_sector);
...
?>
	...
	<div class="sector-menu">
			  <ul class="menu-list menu-list-sectors">
				<li id="<?php print "subsec0"; ?>"><div id="menudiv"><a href="<?php echo $main_path; ?>" >Main</a></div></li>
				...
				?>
				<li id="<?php echo "subsec".($i+1); ?>" class="<?php echo $selcted_class;?>"><div><a href="<?php echo $subsec_path; ?>" class="sub-sectortab"><?php echo $subSectors[$i]['title']; ?></a></div></li>
				<?php } ?>
			  </ul>
			</div>
	   <?php 
